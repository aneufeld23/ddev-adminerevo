...
class DDEVLogin {
    ...
    ?>
        ...
        addEventListener('load', function () {
            ...
            let dbimage = '<?php echo getenv("DDEV_DBIMAGE") ?>'
            ...
            document.querySelector('[name="auth[db]"]').value = '<?php echo getenv('DDEV_DB_NAME'); ?>'
            document.querySelector('[name="auth[username]"]').value = '<?php echo getenv('DDEV_DB_USER'); ?>'
            document.querySelector('[name="auth[password]"]').value = '<?php echo getenv('DDEV_DB_PASS'); ?>'
